      ...
      <div className="container">
        <div className="max-w-xl">
          ...
          <h2 className="mt-4 font-heading text-3xl font-medium md:text-4xl">
            Satu identitas, banyak produk.
          </h2>
        </div>

        {/* Hairline dividers here are load-bearing, not decorative: they
            separate genuinely distinct products under one brand. */}
          ...
          {products.map((product) => (
            <a
              ...
              className={cn(
                ...
                product.status === "active" ? "cursor-pointer" : "cursor-default",
              )}
            >
              <div>
