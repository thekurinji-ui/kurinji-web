  ...
  return (
    <footer className="border-t border-mist bg-paper">
      <div className="container grid gap-12 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3">
            {siteConfig.nav.map((item) => (
              <li key={item.href}>
                <Link href={item.href} className="text-sm text-ink hover:text-bloom">
                  {item.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          <p className="text-xs font-medium uppercase tracking-wider text-muted">Products</p>
          <ul className="mt-4 space-y-3">
            {products.map((product) => (
              <li key={product.slug}>
                <a
                  href={product.url}
                  className="text-sm text-ink hover:text-bloom"
                  target="_blank"
        ...
        <div>
          <p className="text-xs font-medium uppercase tracking-wider text-muted">Social</p>
          <ul className="mt-4 space-y-3">
            <li>
              <a href={siteConfig.socials.instagram} className="text-sm text-ink hover:text-bloom">
                Instagram
              </a>
            </li>
            <li>
              <a href={siteConfig.socials.tiktok} className="text-sm text-ink hover:text-bloom">
                TikTok
              </a>
            </li>
            <li>
              <a href={siteConfig.socials.threads} className="text-sm text-ink hover:text-bloom">
                Threads
              </a>
            </li>
            <li>
